...
import {IMovie, IMovieVideos, IPagination, IVideo} from "../interfaces";
...
const movieService = {
    ...
    getVideoById: (id:string):IRes<IMovieVideos<IVideo>> => apiService.get(urls.movies.video(id.toString()), {params:{language}}),
